...
echo $yellow
figlet -f future "THCA ERROR SYSTEM"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"MRLINK"$cyan" ~/THCA"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"MRLINK"$cyan" ~/THCA"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"MRLINK"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"MRLINK"$cyan" ~/THCA"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"MRLINK"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
...
echo $white "╭─"$green"MLINK"$cyan" ~/THCA"$white
read -p " ╰─$ " target7
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author   : MRLINKERRORSYSTEM	"
echo $purple"Gthub   : https://github.com/404errorsystem"
echo $white"Youtube  : BERBAGIILMUDANAKALSEHAT"
echo
echo $yellow"                          THANKS TO :"
echo
echo $red"[+] Allah SWT "
echo $white"[+] THCA "
echo $red"[+] All Member [THCA] "
echo $white"[+] All Member [SOLOPLAYER] "
echo $red"##########################$green" WELCOME "$red###########################"
